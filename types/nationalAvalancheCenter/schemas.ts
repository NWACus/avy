...
import {fixMalformedISO8601DateString} from 'utils/date';
import {z} from 'zod';
...
import {
  ...
  ProductType,
  Units,
} from 'types/nationalAvalancheCenter/enums';

const datePipeline = z
  .string()
  .transform(s => fixMalformedISO8601DateString(s))
  .transform(s => toDate(s));
...
export const featurePropertiesSchema = z.object({
  ...
  start_date: datePipeline.nullable(),
  end_date: datePipeline.nullable(),
