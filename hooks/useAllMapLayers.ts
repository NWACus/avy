...
export const useAllMapLayers = (center_id: AvalancheCenterID | undefined): UseQueryResult<MapLayer, AxiosError | ZodError> => {
...
function queryKey(nationalAvalancheCenterHost: string, center_id: string) {
  return ['all-map-layer', {host: nationalAvalancheCenterHost, center: center_id}];
}

export const prefetchAllMapLayers = async (queryClient: QueryClient, nationalAvalancheCenterHost: string, center_id: AvalancheCenterID, logger: Logger) => {
