...
import {RooStackNavigator} from 'components/screens/navigation/RootStack';
          ...
          <NavigationContainer linking={linking} ref={navigationRef} onReady={trackNavigationChange} onStateChange={trackNavigationChange}>
            <PostHogProvider
              ...
              <FeatureFlagsProvider>
                <KillSwitchMonitor>
                  <SelectProvider>
                    <StatusBar barStyle={'default'} animated={false} />
                    <View style={{flex: 1}}>
                      <RooStackNavigator requestedTime={requestedTime} centerId={avalancheCenterId} staging={staging} setStaging={setStaging} />
                    </View>
                  </SelectProvider>
                </KillSwitchMonitor>
              </FeatureFlagsProvider>
