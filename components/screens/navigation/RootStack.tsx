...
export const RootStackNavigator: React.FunctionComponent<{
  ...
  return (
    <RootStack.Navigator initialRouteName="drawer">
      ...
      <RootStack.Screen name="observation" component={ObservationScreen} options={{headerBackButtonDisplayMode: 'minimal'}} />
      <RootStack.Screen name="nwacObservation" component={NWACObservationScreen} options={{headerBackButtonDisplayMode: 'minimal'}} />
