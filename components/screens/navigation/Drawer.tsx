...
export const DrawerNavigator: React.FunctionComponent<{
  ...
  const renderBottomTabs = useCallback((_: {route: RouteProp<DrawerParamList, 'MainTabs'>}) => <BottomTabs requestedTime={requestedTime} />, [requestedTime]);
  return (
    <Drawer.Navigator initialRouteName="MainTabs" drawerContent={renderDrawer}>
