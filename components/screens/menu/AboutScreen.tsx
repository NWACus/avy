...
import {Body, BodyXSm, Title3Black} from 'components/text';

export const AboutScreen = (_: NativeStackScreenProps<MenuStackParamList, 'about'>) => {
  return (
    <View style={StyleSheet.absoluteFillObject}>
      <VStack backgroundColor="white" width="100%" height="100%" px={32} pt={16} justifyContent="space-between">
        <VStack space={16}>
          <Center>
            <Title3Black>About Avy</Title3Black>
          </Center>
          <Body>
            The Northwest Avalanche Center developed the Avy app to support wintertime mountain recreation with streamlined avalanche and weather information from avalanche centers
            across the U.S. In year one, the app offers access to the Northwest Avalanche Center and the Sawtooth Avalanche Center with planned expansion in subsequent years.
          </Body>
