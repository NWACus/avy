...
import {ForecastTabNavigatorParamList, MainStackNavigationProps, MainStackParamList} from 'routes';
...
export const ForecastScreen = ({route}: NativeStackScreenProps<MainStackParamList, 'forecast'>) => {
...
const AvalancheForecast: React.FunctionComponent<{
