...
const TextBase: React.FunctionComponent<ITextProps> = props => <Text fontFamily={'Lato_400Regular'} {...props} />;

// TODO figure out letter spacing values - what *are* the react native units?
export const FeatureTitleBlack: React.FunctionComponent<ITextProps> = props => <TextBase fontSize={32} lineHeight={34} fontFamily="Lato_900Black" letterSpacing={0.4} {...props} />;

export const Title1: React.FunctionComponent<ITextProps> = props => <TextBase fontSize={28} lineHeight={34} fontFamily="Lato_400Regular" letterSpacing={0.38} {...props} />;
...
export const Title3: React.FunctionComponent<ITextProps> = props => <TextBase fontSize={20} lineHeight={24} fontFamily="Lato_400Regular" letterSpacing={-0.45} {...props} />;
...
export const Body: React.FunctionComponent<ITextProps> = props => <TextBase fontSize={16} lineHeight={22} fontFamily="Lato_400Regular" letterSpacing={-0.43} {...props} />;
...
export const BodySm: React.FunctionComponent<ITextProps> = props => <TextBase fontSize={14} lineHeight={21} fontFamily="Lato_400Regular" letterSpacing={-0.31} {...props} />;
...
export const BodyXSm: React.FunctionComponent<ITextProps> = props => <TextBase fontSize={12} lineHeight={18} fontFamily="Lato_400Regular" letterSpacing={-0.31} {...props} />;
...
export const AllCapsSm: React.FunctionComponent<ITextProps> = props => (
  <TextBase fontSize={13} lineHeight={18} fontFamily="Lato_400Regular" letterSpacing={-0.08} {..._.merge({style: {textTransform: 'uppercase'}}, props ?? {})} />
);
export const AllCapsSmBlack: React.FunctionComponent<ITextProps> = props => <AllCapsSm fontFamily="Lato_900Black" {...props} />;

export const Caption1: React.FunctionComponent<ITextProps> = props => <TextBase fontSize={12} lineHeight={16} fontFamily="Lato_400Regular" letterSpacing={-0.31} {...props} />;
